...
<body>
<div  class="contianer">
   <form class="form-horizontal" action="<?php echo U('Admin/Cate/addCateHandle');?>" method="post">
        <div class="form-group">
            <label for="inputName" class="col-sm-2 control-label" >添加分类名称</label>
             <div class="col-md-10">
              <input type="text" class="form-control" id="inputName" name='name'>
             </div>
         </div>
  <div class="form-group">
    <label for="inputTitle" class="col-sm-2 control-label">添加分类别名</label>
    <div class="col-md-10">
  ...
  <div class="form-group">
            <label for="inputName" class="col-sm-2 control-label" >排序</label>
             <div class="col-md-10">
              <input type="text" class="form-control" id="inputSort" name='sort' value="100">
             </div>
         </div>
...
<label class="radio-inline">
  <input type="radio" name="status" id="inlineRadio2" value="2">关
      ...
      <input type="hidden" name="level" value="<?php echo ($level); ?>"><?php echo ($level); ?></input>
